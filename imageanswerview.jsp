...
<body style="overflow-x:hidden; overflow:scroll;">
		...
		<input type="hidden" id="numtestvalue" value="<%=imgBean.getImgNum() %>">
		<input type="hidden" id="loginNick" value="<%=Nick %>">
		<a class="btn btn-primary" href="javascript:imganswerview(<%=imgBean.getImgNum() %>);" style="width: 100%;">본문 보기</a>
								<table class="table1" style=" border: 1px solid #dddddd; ">
										<thead id="imgtheadanswer"></thead>
										<tbody id="imgtbodyanswer"></tbody>
										<tfoot>
												<tr>
