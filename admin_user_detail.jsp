		...
		<div class="container">
				<div class="row">
						<table class="table table-stried" style="text-align: center; border: 1px solid #dddddd">
								<thead>
										<tr>
											<th colspan="2" style="background-color: #eeeeee; text-align: center;">회원 정보</th>
										</tr>
								</thead>
								<tbody>
										<tr>
												<th style="text-align: center;" class="form-phone">아이디</th>
												<td style="text-align: center;" class="form-phone"><%=userBean.getUserID() %></td>
										</tr>
										<tr>
										...
										<tr>
												...
												<td style="text-align: center;" class="form-phone"><%=userBean.getUserNick() %></td>
										</tr>
										<tr>
										...
										<tr>
												...
												<td style="text-align: center;" class="form-phone"><%=userBean.getUserDate3() %></td>
										</tr>
										...
										<tfoot>
												<tr>
														<td style="background-color: #eeeeee; text-align: center;" colspan="2">
																<input type="button" class="btn btn-primary pull-right" onclick="history.back()" value="뒤로">
														</td>
												</tr>
										</tfoot>
								</table>
