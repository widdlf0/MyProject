...
<body style="overflow-x:hidden; overflow:scroll;">
		...
		<div class="container">
				<div class="row">
						<form method="post" action="/BbsWriteAction.bo" enctype="multipart/form-data"  name="bbswrite" id="bbswrite">
						<input type="hidden" name="BbsNick" value="<%=Nick %>">
								<table class="table table-stried" style="text-align: center; border: 1px solid #dddddd">
										<thead>
												<tr>
													<th style="background-color: #eeeeee; text-align: center;">이미지 게시판 양식</th>
												</tr>
										</thead>
										<tbody>
												<tr>
												...
												<tr>
														<td><textarea class="form-control" placeholder="글 내용" name="BbsContent"  id="BbsContent" maxlength="3000" style="height: 600px; width: 100%;"></textarea>
...
<!-- 								<a class="btn btn-primary pull-right" onclick="writeform();">글쓰기</a> -->
								<a class="btn btn-primary pull-right"  id="savebutton">글 등록</a>
