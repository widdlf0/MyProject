...
<body style="overflow-x:hidden; overflow:scroll;">
		...
		<div class="container">
				<div class="row">
						<form method="post" action="/ImgInsertAction.img"  name="imagewrite" id="imagewrite">
						<input type="hidden" name="imgNick" value="<%=Nick %>">
								<table class="table table-stried" style="text-align: center; border: 1px solid #dddddd">
										...
										<tbody>
												<tr>
														<th><input type="text" class="form-control" placeholder="글 제목" name="imgSubject" maxlength="50"></th>
												</tr>
												<tr>
														<td><textarea class="form-control" placeholder="글 내용" name="imageContent"  id="imageContent" maxlength="3000" style="height: 600px; width: 100%;"></textarea>
