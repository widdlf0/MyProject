				...
				<tfoot>
					<tr>
						<td colspan="2" style="background-color: #eeeeee; text-align: center;">
 							 <a href="/msgSendTrashBoxUpdate.mg?num=<%=msgBean.getMsgNum()%>&locat=1">[휴지통으로 보내기] </a>&nbsp;&nbsp; 
 							 <a href="/msgReadListAction.mg">[목록]</a>&nbsp;&nbsp;
							
						</td>
					</tr>
				</tfoot>
			</table>
			<a href="/msgwriteanswer.mg?num=<%=msgBean.getMsgNum()%>" class="btn btn-primary pull-right">답장</a>
