...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="/userMyHomeDeleteAction.us"
				name="usermyhomedelete">
					...
					<tbody>
						<tr>
							...
							<td><input type="password" class="form-control"
								...
								id="userPassword" autocomplete="off"></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
	...
	<script>
		function checkalert() {
			...
			if (!document.usermyhomedelete.userPassword.value) {
				alert("비밀번호를 입력하시오.");
				/* alert()는 알람창을 띄운다. */
				document.usermyhomedelete.userPassword.focus();
				return false;
			} else {
				var check;
				check = confirm("회원 탈퇴 하시겠습니까?");

				if (check == true) {
					usermyhomedelete.submit();
				} else {
					return;
				}
			}
