...
<a href="FAQ4.jsp"  class="btn btn-primary" style="width: 24%;">기타</a>
      ...
      <div class="faq">
        ...
        <li class="article">
            	...
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 맛집검색은 어떻게 하나요?</a></p>
            	<div id="50_content" style="display:none;">
	            	<p class="a">A: Q. 위에 메뉴바에서 맛집검색을 들어가셔서 검색하시면 주변의 맛집정보가 나오게 됩니다</p>
	            	</div>
          	</li>
          	<li class="article">
            	<p class="q" onclick="fnShowContent('49')">
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 맛집등록은 어떻게 하나요?</a></p>
        	...
        	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 맛집후기나 평점은 어디서 보나요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 맛있는지 없는지 어떻게 판단하나요?</a></p>
            	<div id="47_content" style="display:none;">
	            	<p class="a">A: 직접가보신 고객님들이 댓글과 평점을 남겨주십니다</p>
	            	</div>
          	</li>
          	<li class="article">
            	<p class="q" onclick="fnShowContent('46')">
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 맛집등록하고 싶은데 어떻게 하나요?</a></p>
            	<div id="46_content" style="display:none;">
	            	<p class="a">A: 맛집등록을 누르셔서 필요한 정보를 입력하시고 맛집으로 등록하시면 됩니다</p>
	            	</div>
          	</li>
          	<li class="article">
            	<p class="q" onclick="fnShowContent('45')">
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 평점을 매기면 여러사람들이 입력할텐데 평균이 매겨지는 건가요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 추천해주실만한 맛집 있나요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [맛집검색 및 사용법] 이 기능좀 추가시켜주세요</a></p>
