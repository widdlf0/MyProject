...
<a href="FAQ4.jsp"  class="btn btn-primary" style="width: 24%;">기타</a>
      ...
      <div class="faq">
        ...
        <li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 여기는 뭐하는 사이트인가요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 맛집등록은 어떻게 하나요?</a></p>
        	...
        	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 맛집후기나 평점은 어디서 보나요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 사다리게임은 왜 있는건가요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 고객센터는 무슨 용도인가요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 평점을 매기면 여러사람들이 입력할텐데 평균이 매겨지는 건가요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 추천해주실만한 맛집 있나요?</a></p>
          	...
          	<li class="article">
            	...
            	<a href="#" class="trigger">Q: [이 사이트의 용도] 이 기능좀 추가시켜주세요</a></p>
