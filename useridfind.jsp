...
<body>
			...
			$("#userName2").keyup(function() {
				...
				$.ajax({
					...
					success : function(args) {
						...
						/* if(args.result4==true){
							$("#idfindbutton").prop("disabled", false);
							$("#idfindbutton").css("background-color", "blue");
							$("#userName2").css("background-color", "#D0F5A9");
							$("#userNamecheck2").css("color", "green");
							$("#userNamecheck2").text(args.userNamecheck2);
							$("#userNamecheck2").show();
							
						}else if(args.result4==false){
							$("#idfindbutton").prop("disabled", true);
							$("#idfindbutton").css("background-color", "red");
							$("#userName2").css("background-color", "red");
							$("#userNamecheck2").css("color", "red");
							$("#userNamecheck2").text(args.userNamecheck2);
							$("#userNamecheck2").show();
	...
	<div class="container">
		<div class="row">
			<form method="post" action="/SendidMail.us" name="userpwfind">
				...
				<table class="table table-stried"
					...
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #eeeeee; text-align: center;">아이디
								찾기</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>이름</td>
							<td><input type="text" name="userName2" id="userName2"
								class="form-phone" placeholder="이름" autocomplete="off"
								style="width: 400px; text-align: center;"> <!-- <span class="btn-group" data-toggle="buttons">
							...
							<br> <span id="userNamecheck2" class="form-phone"
						...
						<tr>
							...
							<td><input type="text" class="form-phone" placeholder="이메일"
								...
								value="메일인증받기" disabled="disabled" id="idfindbutton"
								name="idfindbutton"></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
